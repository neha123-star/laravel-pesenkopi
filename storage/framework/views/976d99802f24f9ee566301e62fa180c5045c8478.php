<?php $__env->startSection('content'); ?>
	...
	<section class="home-slider owl-carousel">
		...
		<div class="slider-item" style="background-image: url(<?php echo e(url('assets/coffe/images/6.png')); ?>);">
			<div class="overlay"></div>
			<div class="container">
				<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
		...
		<div class="slider-item" style="background-image: url(<?php echo e(url('assets/coffe/images/bg_3.png')); ?>);">
			<div class="overlay"></div>
			<div class="container">
				<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="menu-entry">
								<a href="#" class="img"
									style="background-image: url(<?php echo e(url('assets/coffe/images/menu/coffekop/americano_peach.jpg')); ?>);"></a>
							</div>
						</div>
						<div class="col-md-6">
							<div class="menu-entry mt-lg-4">
								<a href="#" class="img"
									style="background-image: url(<?php echo e(url('assets/coffe/images/menu/choco/ice_chocolate.jpg')); ?>);"></a>
							</div>
						</div>
						<div class="col-md-6">
							<div class="menu-entry">
								<a href="#" class="img"
									style="background-image: url(<?php echo e(url('assets/coffe/images/menu/tea/ice_thaitea.jpg')); ?>);"></a>
							</div>
						</div>
						<div class="col-md-6">
							<div class="menu-entry mt-lg-4">
								<a href="#" class="img"
									style="background-image: url(<?php echo e(url('assets/coffe/images/menu/coffekop/ice_kopi_susu_strong.jpg')); ?>);"></a>
							</div>
						</div>
					</div>
				</div>
	...
	<section class="ftco-counter ftco-bg-dark img" id="section-counter" style="background-image: url(<?php echo e(url('assets/coffe/images/bg_2.jpg')); ?>);"
								...
								<div class="tab-pane fade show active" id="v-pills-1" role="tabpanel"
									...
									<div class="row">
										...
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(<?php echo e(url('assets/coffe/images/menu/coffekop/ice_kopi_susu_strawberry.jpg')); ?>);"></a>
												<div class="text">
										...
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(<?php echo e(url('assets/coffe/images/menu/coffekop/ice_kopi_susu_peach.jpg')); ?>);"></a>
												<div class="text">
								...
								<div class="tab-pane fade" id="v-pills-2" role="tabpanel"
									...
									<div class="row">
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(<?php echo e(url('assets/coffe/images/menu/brownis/brownis_waffle_oreo_creamcheese.jpg')); ?>);"></a>
												<div class="text">
										...
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(<?php echo e(url('assets/coffe/images/menu/brownis/brownis_waffle_original.jpg')); ?>);"></a>
												<div class="text">
										...
										<div class="col-md-4 text-center">
											<div class="menu-wrap">
												<a href="#" class="menu-img img mb-4"
													style="background-image: url(<?php echo e(url('assets/coffe/images/menu/brownis/pancong_waffe_coklat_keju.jpg')); ?>);"></a>
												<div class="text">
...
<?php echo $__env->make('layouts.appcoffe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\peesenkopi\resources\views/coffe/index.blade.php ENDPATH**/ ?>