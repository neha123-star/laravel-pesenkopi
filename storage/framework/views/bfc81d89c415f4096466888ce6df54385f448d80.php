...
<div class="main-container">
	<div class="pd-ltr-20 xs-pd-20-10">
		<div class="min-height-200px">
			...
			<form method="post" action="<?php echo e(route('tea.store')); ?>" enctype="multipart/form-data">
					...
					<div class="form-group row">
						...
						<?php if($errors->has('nama_tea')): ?>
                                <div class="text-danger">
                                    <?php echo e($errors->first('nama_tea')); ?>
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-md-10">
							...
							<?php if($errors->has('harga_tea')): ?>
                                <div class="text-danger">
                                    <?php echo e($errors->first('harga_tea')); ?>
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-md-10">
							...
							<?php if($errors->has('gambar_tea')): ?>
                                <div class="text-danger">
                                    <?php echo e($errors->first('gambar_tea')); ?>
					...
					<div class="form-group row">
						...
						<div class="col-sm-12 col-md-10">
							...
							<?php if($errors->has('keterangan_tea')): ?>
                                <div class="text-danger">
                                    <?php echo e($errors->first('keterangan_tea')); ?>
...
<?php echo $__env->make('layouts.appadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\peesenkopi\resources\views/admin/menu/minuman/tea/tambah.blade.php ENDPATH**/ ?>