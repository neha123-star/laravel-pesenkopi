		          ...
		          <div class="col-md-12 d-flex align-items-center">
		            ...
		            <div class="tab-content ftco-animate" id="v-pills-tabContent">
		              	...
		              	<div class="row">
							<?php $__currentLoopData = $kopiice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ki): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		              		<div class="col-md-4 text-center" style="margin-right: auto">
		              			<div class="menu-wrap">
									  <img src="<?php echo e(url('assets/uploads/minuman/kopi/'.$ki->gambar_koice)); ?>" class="menu-img img mb-4 text-center" style="display: block; margin: auto;" alt="">
		              				<div class="text-center">
		              					<h3><a href="#"><?php echo e($ki->nama_koice); ?></a></h3>
		              					<p class="d-inline-block text-truncate" style="max-width: 200px;"><?php echo e($ki->keterangan_koice); ?></p>
		              					<p class="price"><span><?php echo e($ki->harga_koice); ?>K</span></p>
		              				</div>
		              			</div>
							  </div>
					  ...
					  <div class="tab-pane fade" id="tea" role="tabpanel" aria-labelledby="tea-tab">
						<div class="row">
						  <?php $__currentLoopData = $tea; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $te): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="col-md-4 text-center">
								<div class="menu-wrap">
									<img src="<?php echo e(url('assets/uploads/minuman/tea/'.$te->gambar_tea)); ?>" style="display: block; margin: auto;" class="menu-img img mb-4" alt="">
									<div class="text-center">
										<h3><a href="#"><?php echo e($te->nama_tea); ?></a></h3>
										<p class="d-inline-block text-truncate" style="max-width: 150px;"><?php echo e($te->keterangan_tea); ?></p>
										<p class="price"><span><?php echo e($te->harga_tea); ?>K</span></p>
									</div>
								</div>
							</div>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="tab-pane fade" id="choco" role="tabpanel" aria-labelledby="choco-tab">
						<div class="row">
						  <?php $__currentLoopData = $choco; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $co): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="col-md-4 text-center">
								<div class="menu-wrap">
									<img src="<?php echo e(url('assets/uploads/minuman/choco/'.$co->gambar_co)); ?>" class="menu-img img mb-4" style="display: block; margin: auto;" alt="">
									<div class="text-center">
										<h3><a href="#"><?php echo e($co->nama_co); ?></a></h3>
										<p class="d-inline-block text-truncate" style="max-width: 150px;"><?php echo e($co->keterangan_co); ?></p>
										<p class="price"><span><?php echo e($co->harga_co); ?>K</span></p>
									</div>
								</div>
							</div>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="tab-pane fade" id="dalgona" role="tabpanel" aria-labelledby="dalgona-tab">
						<div class="row">
						  <?php $__currentLoopData = $dalgona; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="col-md-4 text-center">
								<div class="menu-wrap">
									<img src="<?php echo e(url('assets/uploads/minuman/dalgona/'.$dg->gambar_dg)); ?>" class="menu-img img mb-4" style="display: block; margin: auto;" alt="">
									<div class="text-center">
										<h3><a href="#"><?php echo e($dg->nama_dg); ?></a></h3>
										<p class="d-inline-block text-truncate" style="max-width: 150px;"><?php echo e($dg->keterangan_dg); ?></p>
										<p class="price"><span><?php echo e($dg->harga_dg); ?>K</span></p>
									</div>
								</div>
							</div>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="tab-pane fade" id="bottle" role="tabpanel" aria-labelledby="bottle-tab">
						<div class="row">
						  <?php $__currentLoopData = $bottle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="col-md-4 text-center">
								<div class="menu-wrap">
									<img src="<?php echo e(url('assets/uploads/minuman/bottle/'.$bt->gambar_bt)); ?>" class="menu-img img mb-4" style="display: block; margin: auto;" alt="">
									<div class="text-center">
										<h3><a href="#"><?php echo e($bt->nama_bt); ?></a></h3>
										<p class="d-inline-block text-truncate" style="max-width: 150px;"><?php echo e($bt->keterangan_bt); ?></p>
										<p class="price"><span><?php echo e($bt->harga_bt); ?>K</span></p>
									</div>
								</div>
							</div>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="tab-pane fade" id="brownis" role="tabpanel" aria-labelledby="brownis-tab">
						<div class="row">
						  <?php $__currentLoopData = $brownis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $br): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="col-md-4 text-center">
								<div class="menu-wrap">
									<img src="<?php echo e(url('assets/uploads/snack/'.$br->gambar_br)); ?>" class="menu-img img mb-4"style="display: block; margin: auto;" alt="">
									<div class="text-center">
										<h3><a href="#"><?php echo e($br->nama_br); ?></a></h3>
										<p class="d-inline-block text-truncate" style="max-width: 150px;"><?php echo e($br->keterangan_br); ?></p>
										<p class="price"><span><?php echo e($br->harga_br); ?>K</span></p>
									</div>
								</div>
							</div>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.appcoffe', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\peesenkopi\resources\views/coffe/menu.blade.php ENDPATH**/ ?>